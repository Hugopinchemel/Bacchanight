...
saveButton.addEventListener('click', async () => {
    ...
    result.setAttribute('viewBox', '0 0 1885 2290');
    result.setAttribute('width', '1885');
    result.setAttribute('height', '2290');
    ...
    if (textureImg) {
        ...
        svgImage.setAttribute('width', '1885');
        svgImage.setAttribute('height', '2290');
    ...
    if (data && data.success && data.fileName) {
        window.location.href = `/view-char/${data.fileName}`;
    } else {
